...
import ru.ppzh.quoteParser.containInReplyToHeader
import ru.ppzh.quoteParser.getEmailText
import ru.ppzh.quoteParser.getMimeMessage
import java.io.File
...
fun main(args: Array<String>) {
    if (args.size > 0) {
        ...
        if (file.exists()) {
            ...
            val emailText = getEmailText(msg)
            
            val c = QuoteParser.Builder()
                    .build()
                    .parse(emailText.lines(), hasInReplyTo)
